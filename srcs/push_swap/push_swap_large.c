...
/*
** is_all_zero() checks if bits in a certain
** column in the stack are all zeros:
**
**	Stack A
**	--------
**	00000001
...
**		|
**
** This optimizes the radix sort since these
** group sort routines can be skipped.
*/

bool	is_all_zero(t_num *stack, int i)
{
	t_num	*num;
